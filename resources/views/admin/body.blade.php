                ...
                <div class="row">
                    <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                            <h3 class="mb-0">{{ number_format($totCount) }}</h3>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                            <h3 class="mb-0">{{ number_format($doctorCount) }}</h3>
...
<div class="col-md-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">MRI Scan Data</h4>

            <!-- Dynamic Pie Chart -->
            <canvas id="dynamic-chart" class="mri-pie-chart"></canvas>
            ...
            <div class="mt-4">
                ...
                <div class="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                    <div class="text-md-center text-xl-left">
                        <h6 class="mb-1">{{ ucfirst($report->report_class) }}</h6>
                        <p class="text-muted mb-0">Last Updated: {{ $report->last_updated ?? \Carbon\Carbon::now()->format('d M Y, h:i A') }}</p>
                    </div>
                    <div class="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
                        <h6 class="font-weight-bold mb-0">{{ $report->total }}</h6>
                    </div>
                </div>
                @endforeach
            </div>
...
<script>
    // Pass the report data to JavaScript
    var reportData = @json($reportCounts);

    // Prepare the labels and data for the chart
    var labels = reportData.map(function(report) {
        return report.report_class; // Label for the chart
    });

    var data = reportData.map(function(report) {
        return report.total; // Data values for the chart
    });
    ...
    var dynamicChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'MRI Scan Data',
                data: data,
                backgroundColor: ['#4CAF50', '#FFC107', '#FF5722', '#2196F3', '#9C27B0'], // Customize colors as needed
                borderColor: '#fff',
                borderWidth: 1
            }]
        },
...
<!-- Add this CSS to control the canvas size -->
<style>
    .mri-pie-chart {
        width: 100% !important; /* Ensure it takes full width */
        height: 300px !important; /* Set height for good visibility */
